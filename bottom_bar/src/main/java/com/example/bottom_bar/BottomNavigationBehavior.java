...
class BottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    private final BottomNavigationBehavior.BottomNavigationWithSnackbar mWithSnackBarImpl = Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? new BottomNavigationBehavior.LollipopBottomNavWithSnackBarImpl() : new BottomNavigationBehavior.PreLollipopBottomNavWithSnackBarImpl();
    ...
    private class PreLollipopBottomNavWithSnackBarImpl implements BottomNavigationBehavior.BottomNavigationWithSnackbar {
    ...
    private class LollipopBottomNavWithSnackBarImpl implements BottomNavigationBehavior.BottomNavigationWithSnackbar {
        @Override
        public void updateSnackbar(CoordinatorLayout parent, View dependency, View child) {
            if (!isTablet && dependency instanceof Snackbar.SnackbarLayout) {
                if (mSnackbarHeight == -1) {
